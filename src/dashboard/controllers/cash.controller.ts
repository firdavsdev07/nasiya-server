...
class CashController {
  ...
  async confirmations(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      console.error("❌ Error in confirmations controller:", error);
      return next(error);
    }
  }
  ...
  async getPendingPayments(req: Request, res: Response, next: NextFunction) {
    try {
      console.log("🔍 GET /cash/pending - Fetching pending payments");
      ...
      console.error("❌ Error in getPendingPayments controller:", error);
      return next(error);
    }
  }
  ...
  async confirmPayments(req: Request, res: Response, next: NextFunction) {
    try {
      console.log("✅ POST /cash/confirm-payments - Confirming payments");
      ...
      console.error("❌ Error in confirmPayments controller:", error);
      return next(error);
    }
  }
  ...
  async rejectPayment(req: Request, res: Response, next: NextFunction) {
    try {
      console.log("❌ POST /cash/reject-payment - Rejecting payment");
      ...
      console.error("❌ Error in rejectPayment controller:", error);
      return next(error);
    }
  }
}
